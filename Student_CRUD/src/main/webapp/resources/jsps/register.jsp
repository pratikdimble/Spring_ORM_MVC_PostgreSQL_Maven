...
<body>
	...
	<!--//header-->
	<div class="main-content-agile"  ng-controller = "registercontroller" ng-form="mvcForm">
		<div class="sub-main-w3">
		<div class="pom-agile">
				<span class="fa fa-user-o" aria-hidden="true"></span>
					<input placeholder="Firstname"  class="user" ng-model="form1.studentFname" type="text" required="">
			</div>
			<div class="pom-agile">
				<span class="fa fa-user-o" aria-hidden="true"></span>
					<input placeholder="Lastname"  class="user" ng-model="form1.studentLname" type="text" required="">
			</div>
			<div class="pom-agile">
				<span class="fa fa-user-o" aria-hidden="true"></span>
			...
			<div class="pom-agile">
				...
				<div class="clear"></div>
				<div class="right-w3l">
					<button ng-click="add()">Register</button>
				</div>
